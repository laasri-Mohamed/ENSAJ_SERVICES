...
declare module 'util' {
    ...
    */
    ...
    type ExtractOptionValue<T extends ParseArgsConfig, O extends ParseArgsOptionConfig> = IfDefaultsTrue<T['strict'],
    ...
    type ParsedValues<T extends ParseArgsConfig> =
        ...
        ? {
            -readonly [LongOption in keyof T['options']]: IfDefaultsFalse<T['options'][LongOption]['multiple'],
                undefined | Array<ExtractOptionValue<T, T['options'][LongOption]>>,
                undefined | ExtractOptionValue<T, T['options'][LongOption]>>;
        }
        : {});

    type ParsedPositionals<T extends ParseArgsConfig> = IfDefaultsTrue<T['strict'],
    ...
    type ParsedPositionalToken<T extends ParseArgsConfig> = IfDefaultsTrue<T['strict'],
        IfDefaultsFalse<T['allowPositionals'], { kind: 'positional'; index: number; value: string }, never>,
        IfDefaultsTrue<T['allowPositionals'], { kind: 'positional'; index: number; value: string }, never>>;

    type ParsedTokens<T extends ParseArgsConfig> = Array<ParsedOptionToken<T> | ParsedPositionalToken<T> | { kind: 'option-terminator'; index: number }>;
