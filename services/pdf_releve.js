...
function buildPDF(dataCallback, endCallback, releve) {
    ...
    doc
        ...
        .fontSize(15)
        .text(
            "Code Nationale de l'élève ingénieur : " + releve.cne, {
            width: 410,
            align: 'left'
        }
        )
    ...
    doc
        ...
        .fontSize(15)
        .text(
            "Filière et année : " + releve.filiere, {
            width: 410,
            align: 'left'
        }
        )
